...
?>
    <section class="p-3 p-md-4 p-xl-5 login-section">
        <img src="/assets/images/item3.png" class="login-section-img">
        <div class="container position-relative">
            <img src="/assets/images/leaves1.png" class="card-login-img rounded">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-5">
                                        ...
                                        if (!empty(app()->session->getFlash('success'))) {
                                            echo '<div class="alert alert-success">' . app()->session->getFlash('success') . '</div>';
                                        }
                                        ?>
                                    </div>
                                </div>
                                <form action="/login" method="post">
                                    <div class="row gy-3 gy-md-4 overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button class="btn bsb-btn-xl btn-primary" type="submit">Log in now
                                                </button>
                                            </div>
                                        </div>
                                    </div>
